...
in {
  desktop-glass =
    pkgs.runCommand "desktop-glass-checks" {
      ...
      assert_file_not_contains ${../modules/home/dms/common-patches.nix} 'settings_shell_alpha'
      assert_file_not_contains ${../modules/home/dms/common-patches.nix} 'Modules/Settings/Widgets/SettingsCard.qml'
      ...
      assert_file_contains ${../modules/home/glass.nix} 'quickSearchSurfaceOpacity = "1.00";'
      assert_file_contains ${desktopSpicetifyAdditionalCssFile} '--system-spicetify-quick-search-surface: rgba(var(--spice-rgb-card), 1.00) !important;'
      ...
      assert_file_contains ${desktopSpicetifyAdditionalCssFile} '[data-tippy-root]:has([role="menu"])'
      assert_file_contains ${desktopSpicetifyAdditionalCssFile} '[data-system-manifest-row-play-tooltip="true"]'
      assert_file_contains ${desktopSpicetifyAdditionalCssFile} 'border: 0 !important;'
      assert_file_contains ${desktopSpicetifyAdditionalCssFile} 'outline: none !important;'
      ...
      assert_file_not_contains ${desktopSpicetifyAdditionalCssFile} '[data-tippy-root] {'
      assert_file_not_contains ${desktopSpicetifyAdditionalCssFile} '[data-tippy-root] [role="menu"]'
      ...
      assert_file_contains ${desktopSpicetifyExtraCommandsFile} 'markSystemManifestRowPlayTooltips'
      assert_file_contains ${desktopSpicetifyExtraCommandsFile} '/^Play\s+.+\s+by\s+.+$/'
      ...
      assert_file_contains ${../modules/home/vesktop.nix} 'SRC_JSON="$HOME/.cache/DankMaterialShell/dms-colors.json"'
      assert_file_contains ${../modules/home/vesktop.nix} 'systemd.user.paths.vesktop-palette-sync'
      assert_file_contains ${../modules/home/vesktop.nix} 'PathChanged = "%h/.cache/DankMaterialShell";'
      assert_file_not_contains ${../modules/home/vesktop.nix} '.cache/skwd-wall-v2/colors.json'
      assert_file_not_contains ${../modules/home/vesktop.nix} '.cache/skwd-wall/colors.json'
      assert_file_contains ${../modules/home/hyprland.nix} 'DankMaterialShell/dms-colors.json'
      assert_file_contains ${../modules/home/hyprland.nix} 'hl.config({'
      assert_file_contains ${../modules/home/hyprland.nix} 'active_border = \"rgb($primary)\"'
      assert_file_contains ${../modules/home/hyprland.nix} 'locked_active = \"rgb($error)\"'
      assert_file_contains ${../modules/home/hyprland.nix} '--quiet eval "$expression"'
      assert_file_not_contains ${../modules/home/hyprland.nix} 'require_optional("dms.colors")'
      assert_file_contains ${../modules/home/dms/settings.nix} 'matugenTemplateHyprland = false;'
