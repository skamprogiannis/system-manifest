...
- **Style:** Do NOT use emojis in documentation or commit messages unless explicitly requested. Use generic design terms like **Glassmorphism** instead of platform-specific ones (like Apple's).
