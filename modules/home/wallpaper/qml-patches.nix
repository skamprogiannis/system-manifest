    ...
    raw = ''
          ...
          selector_text = replace_all(
            ...
            function _setThemeMode(mode) {
              ...
              Quickshell.execDetached([Config.scriptsDir + "/schedule-dms-wallpaper-sync.sh"])
              return true
            }
          ...
          dms_sync_addition = (
              ...
              "    interval: 750\n"
              "    repeat: false\n"
              "    onTriggered: Quickshell.execDetached([Config.scriptsDir + \"/schedule-dms-wallpaper-sync.sh\"])\n"
              "  }\n"
          )
