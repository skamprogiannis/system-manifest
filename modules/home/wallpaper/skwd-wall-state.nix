{
  ...
  # Hyprland/DMS colors.lua - Material Design 3 tokens consumed by Lua config.
  hyprlandDmsTemplate = pkgs.writeText "hyprland-dms-colors.lua" ''
    -- Auto-generated by skwd-wall Matugen hook.
    hl.config({
      general = {
        col = {
  ...
  skwdTemplatesDir = pkgs.runCommand "skwd-wall-templates" {} ''
    ...
    cp ${hyprlandDmsTemplate} $out/hyprland-dms-colors.lua
